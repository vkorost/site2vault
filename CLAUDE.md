...
- Architecture doc: `site2vault-architecture.md` (detailed technical reference)
- Improvements spec: `site2vault-improvements-assignment.md` (10-item assignment, all completed)
